...
const Sidebar = ({ isOpen, onToggle, onLogout, user, currentPath }) => {
  const navItems = [
        ...
        <div className="flex flex-col h-full">
          <div className="flex items-center justify-between h-16 px-4 border-b border-gray-200">
            {isOpen && (
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-gray-800">EPMS</span>
              </div>
            )}
            <button
              onClick={onToggle}
          ...
          <div className="p-4 border-t border-gray-200">
            ...
            {!isOpen && (
              <button
                onClick={onLogout}
                className="w-full p-2 text-gray-500 hover:text-red-600 hover:bg-red-50 rounded-lg transition-colors"
                title="Sign Out"
              >
